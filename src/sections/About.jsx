...
const About = ({ TextColor, bg }) => {
  return (
    <div id="about" className={`min-h-screen flex justify-center ${bg}`}>
      <div className="w-full max-w-4xl flex flex-col  items-center gap-15 pt-32 px-3">
        <h1 className={`font-bold text-4xl text-center ${TextColor}`}>
          About Me
        </h1>
        <div className={`${TextColor} max-w-2xl md:text-2xl text-xl text-center`}>
